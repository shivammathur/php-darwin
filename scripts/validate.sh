...
node --test "$script_dir/test-supervise-build.cjs" || php_darwin_die 'source build cancellation validation failed'
node --test "$script_dir/test-run-setup-php.cjs" || php_darwin_die 'unchanged setup-php execution validation failed'
