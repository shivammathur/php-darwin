...
php_darwin_timed homebrew.packages.plan php_darwin_install_state plan "$brew_prefix" \
...
php_darwin_timed homebrew.packages.receipts php_darwin_install_state receipts "$brew_prefix" \
